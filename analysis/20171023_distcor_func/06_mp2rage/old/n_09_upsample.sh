...
strPathTarget="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20161221/nii_distcor/mp2rage/04_seg/01_native_space/"

# Output path:
strPathOt="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20161221/nii_distcor/mp2rage/04_seg/02_up/"
...
do
	...
	strTmpOt="${strPathOt}${aryIn[index_01]}"
