...
strPthIn="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171023/nii_distcor/feat_level_1/func_07.feat/filtered_func_data"

# Output file:
strPthOut="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171023/nii_distcor/retinotopy/func_prepro/filtered_func_up"
