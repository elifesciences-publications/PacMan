...
strNiiX = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/pRF_results_x_pos.nii.gz'  #noqa

# Path of nii file with y-coordinates of pRFs:
strNiiY = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/pRF_results_y_pos.nii.gz'  #noqa

# Path of nii file with pRF size estimates (SD):
strNiiSd = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/pRF_results_SD.nii.gz'  #noqa

# Path of nii file with R2 values:
strNiiR2 = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/pRF_results_R2.nii.gz'  #noqa

# Output file base name:
strNiiOt = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/pRF_results_'  #noqa
