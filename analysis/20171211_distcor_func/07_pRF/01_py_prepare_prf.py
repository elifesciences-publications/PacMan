...
strPthCombMean = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171211/nii_distcor/func_reg_tsnr/'  #noqa
strCombMean = 'combined_mean.nii.gz'

# Path & filename of output (binary brain mask):
strPathOut = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171211/nii_distcor/retinotopy/mask/'  #noqa
