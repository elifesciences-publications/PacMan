...
# Input directory:
strPthIn="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180118/nii_distcor/retinotopy/pRF_results/"

# Output directory:
strPthOut="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180118/nii_distcor/retinotopy/pRF_results_up/"
