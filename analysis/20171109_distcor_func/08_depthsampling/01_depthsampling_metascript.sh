...
strPthCbs="/home/john/PhD/GitHub/PacMan/analysis/20171109_distcor_func/08_depthsampling/"

# Names of CBS layouts to run (xml files):
aryCbs=(20171109_mp2rage_lh_equivol_retino_stats.LayoutXML \
        20171109_mp2rage_rh_equivol_retino_stats.LayoutXML
        20171109_mp2rage_lh_equivol_ert.LayoutXML \
        20171109_mp2rage_rh_equivol_ert.LayoutXML \
        20171109_mp2rage_lh_equivol_ert_long.LayoutXML \
        20171109_mp2rage_rh_equivol_ert_long.LayoutXML)
...
# Working directory:
strPthWd="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/cbs_distcor/cbs_wd"
#------------------------------------------------------------------------------
