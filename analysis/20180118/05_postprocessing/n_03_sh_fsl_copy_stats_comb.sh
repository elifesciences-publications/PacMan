...
strPathParent03=".gfeat/cope2.feat/stats/zstat1.nii.gz"
...
do
	...
	strTmpOut="${strPathOutput}${index01}_zstat1_sustained.nii.gz"
...
do
	...
	strTmpOut="${strPathOutput}${index01}_zstat1_transient.nii.gz"
	echo "------cp ${strTmpIn} ${strTmpOut}"
	cp ${strTmpIn} ${strTmpOut}
