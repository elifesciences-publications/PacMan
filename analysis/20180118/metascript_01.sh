...
docker run -it --rm \
    ...
    -e pacman_cpu \
    -e USER \
    dockerimage_pacman_jessie_mcr2016 /home/john/PhD/GitHub/PacMan/analysis/20180118/metascript_02b.sh &> /home/john/Dropbox/Sonstiges/docker_log_${pacman_sub_id}.txt
#-------------------------------------------------------------------------------
