...
echo "-ParCon Analysis Pipleline --- 20171213"
date
...
matlab -nodisplay -nojvm -nosplash -nodesktop \
  -r "run('/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/01_preprocessing/n_06a_spm_create_moco_batch.m');"
date

echo "---Automatic: Run SPM motion correction on opposite-phase polarity data"
matlab -nodisplay -nojvm -nosplash -nodesktop \
  -r "run('/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/01_preprocessing/n_06c_spm_create_moco_batch_op.m');"
date
...
matlab -nodisplay -nojvm -nosplash -nodesktop \
  -r "run('/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/06_mp2rage/n_02_spm_bf_correction.m');"
date
...
matlab -nodisplay -nojvm -nosplash -nodesktop \
  -r "run('/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/06_mp2rage/n_07_spm_create_corr_batch_prereg.m');"
date
