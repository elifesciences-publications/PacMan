...
# Parent directory:
strPathParent="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171213/nii_distcor/"

# Functional runs (input & output):
aryRun=(func_00)

# Name of configuration file:
strPathCnf="/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/01_preprocessing/n_08b_highres.cnf"

# Path for 'datain' text file with acquisition parameters for topup (see TOPUP
# documentation for details):
strDatain01="/home/john/PhD/GitHub/PacMan/analysis/20171213_distcor_func/01_preprocessing/n_08c_datain_topup.txt"
