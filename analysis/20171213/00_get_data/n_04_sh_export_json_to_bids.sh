...
cp ${strRaw}PROTOCOL_BP_ep3d_bold_func01_FOV_LR_SERIES_008_c32_e1.json ${strFunc}func_01.json
...
cp ${strRaw}PROTOCOL_BP_ep3d_bold_func07_FOV_RL_pRF_SERIES_026_c32_e1.json ${strFunc}func_07.json
