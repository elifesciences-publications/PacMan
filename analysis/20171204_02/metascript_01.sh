...
docker run -it --rm \
    ...
    -e pacman_cpu \
    -e USER \
    dockerimage_pacman_jessie /home/john/PhD/GitHub/PacMan/analysis/${pacman_sub_id}/metascript_02.sh &> /home/john/Dropbox/Sonstiges/docker_log_${pacman_sub_id}.txt
#-------------------------------------------------------------------------------
