...
# Input directory:
strPthIn="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171211/nii_distcor/stat_maps_trans/"

# Output directory:
strPthOut="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171211/nii_distcor/stat_maps_trans_up/"
