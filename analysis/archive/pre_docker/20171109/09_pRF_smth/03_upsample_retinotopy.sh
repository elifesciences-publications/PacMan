...
# Input directory:
strPthIn="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results/"

# Output directory:
strPthOut="/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20171109/nii_distcor_prf_smth/retinotopy/pRF_results_up/"
