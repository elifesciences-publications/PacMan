...
strPathRef = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180111/nii_distcor/mp2rage/03_reg/03_prereg/combined_mean/';
% Directory of source image (T1-weighted mp2rage image):
strPathSrc = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180111/nii_distcor/mp2rage/03_reg/03_prereg/mp2rage_t1w/';
% Directory of other images to be registered along source image (T1, PDw,
% INV2):
strPathOtr = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180111/nii_distcor/mp2rage/03_reg/03_prereg/mp2rage_other/';
% Name of the 'SPM batch' to be created:
strPathBatch = '/media/sf_D_DRIVE/MRI_Data_PhD/05_PacMan/20180111/nii_distcor/mp2rage/03_reg/03_prereg/spm_corr_batch.mat';
