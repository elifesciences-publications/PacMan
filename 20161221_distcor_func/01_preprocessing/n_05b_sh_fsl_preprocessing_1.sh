...
# Output directory:
strPathOutput="${strPathParent}func_regAcrssRuns_op/"
#-------------------------------------------------------------------------------
...
do
	...
	strTmp01="${strPathInput}${index01}_op/r${index01}"
	...
	strTmp03="${strPathInput}${index01}_op/${index01}.nii"

	# The time series that has been 'resliced':
	strTmp04="${strPathInput}${index01}_op/r${index01}.nii"
