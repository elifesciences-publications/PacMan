...
% by SPM.
% NOTE: This version has been adapted to also register opposite-phase data.
%--------------------------------------------------------------------------
...
strPathParent = '/home/john/Desktop/20161221_topup_test/spm_regAcrssRuns/';
...
cllPathFunc = cell(1,(varNumRuns * 2));
% Put main functional data into the batch:
...
% Put opposite-phase data into the batch:
for index_01 = 1:varNumRuns
    if index_01 < 10
        strTmp = strcat(strPathParent, ...
            'func_0', ...
    ...
    cllPathFunc{(index_01 + varNumRuns)} = spm_select('ExtList', ...
        strTmp, ...
        '.nii', ...
        Inf);
    cllPathFunc{(index_01 + varNumRuns)} = ...
        cellstr(cllPathFunc{(index_01 + varNumRuns)});
    cllPathFunc{(index_01 + varNumRuns)} = ...
        strcat(strTmp, cllPathFunc{(index_01 + varNumRuns)});
end
%--------------------------------------------------------------------------
